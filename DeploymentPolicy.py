...
License: GPL
Created: 8/10/2002
$Id: DeploymentPolicy.py 1661M 2010-09-27 14:51:10Z (local) $
"""
...
#        import pdb
#        pdb.set_trace()
#KW:     Only call exportNotify() to email your site Managers of completion of export IF you have defined the expected site properties used by it (defined in that method below.)
#        self.exportNotify(REQUEST)
    ...
    def exportNotify(self, REQUEST):
	    """Notifies users with site-wide Manager role of completion of static export deployment."""
	...
	mTo = ','.join(zopeusers)
        ...
        #KW: URL modifying code below is client-specific - you might provide a URL in the email that links to a separate, viewable static site
        #    and this URL is likely different than the URL you used to execute the deployment.
        #    For our site, we define site properties of email_charset = utf-8, preview_domain = www.somedomain-preview.com, and email_from_address = info@somedomain.com 
        ...
        mMsg = "The export has completed. You may review the results on your static site URL.  \n\n\n\n---\nCMS Portal Administrator"
...
#           import pdb
#           pdb.set_trace()
#           mailhost.secureSend(mMsg, mTo, mFrom, subject=mSubj, subtype='', charset=encoding, debug=False, From=mFrom)
#KW:        I believe the following send method below will work with Plone 4; the secureSend() is deprecated as of Plone 4.
